          ...
          {mode === 'signup' && (
            <>
              ...
              <div>
                ...
                <RadioGroup name="role" defaultValue={state.role || 'student'} className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="student" id="student" />
                    <Label htmlFor="student" className="text-sm">Student</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="workplace_newcomer" id="workplace_newcomer" />
                    <Label htmlFor="workplace_newcomer" className="text-sm">Workplace Newcomer</Label>
                  </div>
                  <div className="flex items-center space-x-2">
