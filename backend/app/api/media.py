...
from ..models.experience import MediaType
...
async def upload_media_file(
    ...
    try:
        ...
        media_doc = {
            ...
            "filePath": encrypt_data(processing_result["filePath"]),  # Encrypt file path
...
async def get_user_media_files(
    ...
    try:
        ...
        # Fetch files
        cursor = media_collection.find(query).sort("uploadedAt", -1).skip(skip).limit(limit)
        ...
        async for media_file in cursor:
            ...
            file_info = {
                ...
                "description": decrypt_data(media_file["description"]) if media_file.get("description") else None,
...
async def get_media_file_details(
    ...
    try:
        ...
        file_details = {
            ...
            "transcript": decrypt_data(media_file["metadata"].get("transcript")) if media_file["metadata"].get("transcript") else None
        }
