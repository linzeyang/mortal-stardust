...
from ..utils.encryption import encrypt_data, decrypt_data, generate_key_pair
...
class SecureDataService:
    ...
    async def get_user_data_inventory(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            results = await self.db.encrypted_records.aggregate(pipeline).to_list(length=None)
    ...
    async def _log_access(
        ...
        try:
            access_log = {
                ...
                "ipAddress": request_context.get("ip_address") if request_context else None,
                "userAgent": request_context.get("user_agent") if request_context else None,
    ...
    async def get_access_logs(
        ...
        try:
            ...
            logs = await self.db.access_logs.find(query)\
                .sort("timestamp", -1)\
                .limit(limit)\
