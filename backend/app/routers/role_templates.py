...
async def list_templates(
    role: Optional[UserRole] = None, current_user: User = Depends(get_current_user)
):
    """
...
async def get_template_by_user_role(
    role: UserRole, current_user: User = Depends(get_current_user)
):
    """
...
async def validate_template_data(
    template_id: str, form_data: dict, current_user: User = Depends(get_current_user)
):
    """
