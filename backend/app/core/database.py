...
async def init_database_indexes():
    ...
    try:
        ...
        await db.database.solutions.create_index([("userId", 1), ("experienceId", 1), ("stage", 1)])
        ...
        await db.database.solution_ratings.create_index([("userId", 1), ("solutionId", 1)], unique=True)
        ...
        await db.database.experience_summaries.create_index([("user_id", 1), ("experience_id", 1)])
        await db.database.experience_summaries.create_index([("user_id", 1), ("created_at", -1)])
        ...
        await db.database.analytics_results.create_index([("user_id", 1), ("analytics_type", 1)])
        await db.database.analytics_results.create_index([("user_id", 1), ("created_at", -1)])
