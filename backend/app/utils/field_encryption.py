...
class FieldEncryptor:
    ...
    def encrypt_document(self, document: Dict[str, Any], schema_name: str) -> Dict[str, Any]:
    ...
    def decrypt_document(self, document: Dict[str, Any], schema_name: str) -> Dict[str, Any]:
            ...
            if should_encrypt:
                ...
                if value is not None:
                    try:
                        ...
                        self._set_nested_value(decrypted_doc, field_path, decrypted_value)
    ...
    def _set_nested_value(self, document: Dict[str, Any], path: str, value: Any) -> None:
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            if args and isinstance(args[0], dict):
                args = (field_encryptor.encrypt_document(args[0], schema_name),) + args[1:]
            elif 'document' in kwargs:
                kwargs['document'] = field_encryptor.encrypt_document(kwargs['document'], schema_name)
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            if isinstance(result, dict):
                ...
                return [field_encryptor.decrypt_document(doc, schema_name) for doc in result]
